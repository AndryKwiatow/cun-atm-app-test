  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-xs-12" id="screenView">
        ...
        ?>
        <h1 class="demo-section-title text-uppercase text-center"></h1>
        <h6 class="text-center">###-####-5456</h6>
        <br />
        <div class="row">
          ...
          <div class="col-xs-9">
            <div class="col-xs-12">
              <div class="tile">
                <h4 class="text-uppercase balance"><span>Balance</span>$1,103,500.32</h4>
              </div>
            </div>
            <!-- Options -->
            <div class="col-xs-4">
          ...
          <div class="col-xs-3">
            <div class="tile">
              <a id="back" href="#" class="btn btn-lg btn-inverse text-uppercase btn-padding"><span
                  class="fui-arrow-left"></span> Back</a>
            </div>
            <div class="tile">
              <a id="logout" href="#" class="btn btn-lg btn-info text-uppercase btn-padding"><span
                  class="fui-user"></span> Logout</a>
            </div>
            <div class="tile">
              <a id="cancelTransactin" href="#" class="btn btn-lg btn-danger text-uppercase btn-padding"><span
      ...
      <div class="col-xs-12">
        <h2>
          <blockquote>This ATM System is for software testing only! --- <a href="#">sitemap</a></blockquote>
        </h2>
      </div>
    </div><!-- // END row-->
